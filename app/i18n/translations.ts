...
export const translations = {
  ...
  en: {
    ...
    hero: {
      ...
      title: ["WILMER", "IRIARTE", "DEVELOPER"] as const,
      bio: "I'm a Systems Engineering student at Fundación Universitaria Tecnológico Comfenalco, passionate about building innovative and scalable software solutions. My goal is to develop technology that creates real impact while continuously expanding my skills in the tech industry and delivering excellence in every project.",
